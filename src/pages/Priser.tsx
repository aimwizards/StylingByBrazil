...
import { Search, Scissors, Sparkles, Eye, Star, Zap, Heart } from 'lucide-react';
        ...
        <div className="container max-w-5xl">
          ...
          <div className="flex flex-col md:flex-row gap-6 mb-16">
            ...
            <div className="relative flex-1">
              ...
              <input
                ...
                className="w-full pl-12 pr-4 py-3 rounded-full border border-neutral-200 focus:border-rose-500 focus:ring-2 focus:ring-rose-500/20 outline-none transition-all duration-300"
              />
            </div>
          ...
          {filteredPriceList.length === 0 && (
            <div className="text-center text-neutral-500 mt-8">
              Inga behandlingar hittades för "{searchTerm}"
            </div>
          )}
        </div>
      </section>
